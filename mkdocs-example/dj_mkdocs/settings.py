"""
Django settings for dj_mkdocs project.
...
SECRET_KEY = 'django-insecure-i@-um1che%8b-615v%&)6#!8bf3wnehm)hx%-q^#(gxx2(9aga'
...
WSGI_APPLICATION = 'dj_mkdocs.wsgi.application'
